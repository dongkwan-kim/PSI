...
def get_args(model_name, dataset_name, custom_key="", yaml_path=None, yaml_check=True) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description='Argument Parser for PSI and baselines.')
    ...
    parser.add_argument("--dataset-seed", default=42, type=int)
    ...
    parser.add_argument("--subgraph-infomax-type", default=None)
    parser.add_argument("--negative-sample-type-in-isi", default=None)
    parser.add_argument("--neg-sample-ratio-in-isi", type=float, default=1.0)
...
if __name__ == '__main__':
    test_args = get_args("PSI", "FNTN", "TEST+MEMO")
